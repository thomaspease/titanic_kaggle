...
PATH = '/Users/tompease/Documents/Coding/titanic'
...
class ClassificationTuneModel(TuneModel):
  ...
  def save_model_and_results(self):
    ...
    path = f'{PATH}/models/classification/{self.model_class.__name__}/{dt_string}'
...
class RegressionTuneModel(TuneModel):
  ...
  def save_model_and_results(self):
    ...
    mse_path = f'{PATH}/models/regression/{self.model_class.__name__}/{dt_string}/tuned_for_mse'
    r2_path = f'{PATH}/models/regression/{self.model_class.__name__}/{dt_string}/tuned_for_r2'
